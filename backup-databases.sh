  ...
  do
    ...
    case $i in
      mysql)
        ...
        putBackup $DIR/$PROJECT-$DBNAME-$DATE.sql.gz mysql/$PROJECT/$DC_NAME/$DBNAME-$DATE.sql.gz
        ;;
      postgresql)
        ...
        putBackup $DIR/$PROJECT-$DBNAME-$DATE.pg.gz pgsql/$PROJECT/$DC_NAME/$DBNAME-$DATE.pg.gz
        ;;
      mongodb)
        ...
        putBackup $DIR/$PROJECT-$DBNAME-$DATE.mongodump.gz mongodb/$PROJECT/$DC_NAME/$DBNAME-$DATE.mongodump.gz
        ;;
      *)
