  ...
  do
    ...
    case $i in
      mysql)
        ...
        putBackup $DIR/$PROJECT-$DBNAME-$DATE.sql.gz mysql/$PROJECT/$DBNAME/$DBNAME-$DATE.sql.gz
        ;;
      postgresql)
        ...
        putBackup $DIR/$PROJECT-$DBNAME-$DATE.pg.gz pgsql/$PROJECT/$DBNAME/$DBNAME-$DATE.pg.gz
        ;;
      mongodb)
