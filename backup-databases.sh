  ...
  do
    ...
    case $i in
      mysql)
        ...
        putBackup $DIR/$PROJECT-$DBNAME-$DATE.sql.gz mysql/$PROJECT/$DBNAME-$DATE.sql.gz
        ;;
      postgresql)
        ...
        putBackup $DIR/$PROJECT-$DBNAME-$DATE.pg.gz pgsql/$PROJECT/$DBNAME-$DATE.pg.gz
        ;;
      mongodb)
        ...
        putBackup $DIR/$PROJECT-$DBNAME-$DATE.mongodump.gz mongodb/$PROJECT/$DBNAME-$DATE.mongodump.gz
        ;;
      *)
